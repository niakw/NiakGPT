...
- **Débit amélioré sans sacrifier la reprise** : le checkpoint distant reste par conversation. Les transcripts sont découpés par blocs de 1 000 000 caractères au lieu de 360 000, les blobs d’un commit restent créés avec concurrence bornée et la vérification du caractère privé du dépôt est réutilisée 60 s. Cela réduit fortement les appels GitHub sur les très gros fils sans rejouer un chat déjà validé.

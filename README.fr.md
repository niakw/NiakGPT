...
> **Version actuelle : 0.9.118.** Project Memory traite désormais l’index d’un Project comme une union monotone plutôt qu’un snapshot « dernier écrivain gagne ». Si un ancien onglet/runtime écrase l’index avec quelques lignes seulement, NiakGPT le reconstruit depuis les checkpoints individuels déjà présents dans le coffre privé avant de relire l’historique. Les conversations déjà archivées sont reconnues et sautées au lieu d’être rejouées depuis 0 %.

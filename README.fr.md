...
> **Version actuelle : 0.9.107.** L’hydratation React est désormais vérifiée dans le **monde MAIN** de la page via le service worker MV3 : le content script isolé n’attend plus des expandos React qu’il ne peut pas voir. DOM et CSS restent intacts tant que le HostRoot n’est pas stabilisé.

...
const ISOLATED_RUNTIME=[
  ...
  'pin-folders-v096.js',
  'app-v090.js',
  'native-actions-controller-v119.js',
  'native-actions-v113.js',
  'home-layout-v112.js',
...
chrome.runtime.onMessage.addListener((message,sender,sendResponse)=>{
  ...
  (async()=>{
    ...
    const coreFailed=bootBlocked||errors.some(item=>item.includes(':app-v090.js:')||item.includes(':pin-folders-v096.js:')||item.includes(':project-state-selfheal-v102.js:')||item.includes(':project-assignment-selfheal-v103.js:')||item.includes(':sidebar-projects-authority-v112.js:')||item.includes(':sidebar-projects-v121.js:')||item.includes(':sidebar-metadata-v118.js:')||item.includes(':chat-state-authority-v113.js:')||item.includes(':sidebar-ux-v119.js:')||item.includes(':native-actions-controller-v119.js:')||item.includes(':native-actions-v113.js:')||item.includes(':interruption-guard-v119.js:'));

...
if version!='0.9.118': fail(f"version={version}")
...
if not (ROOT/'visual-lab/project-memory-index-union-v118.mjs').exists(): fail('Project Memory collapsed-index recovery gate missing')

...
for(const token of ['safeInsert(parent,node,before=null)','retireStaleBox','ng121MountPolicy','direct-once','placementTarget(root=navRoot(),box=null)'])need(sidebarProjects,token,'sidebar no-reparent contract incomplete');

...
for(const token of ["classList.add('ng8-native-project","suppressNative();"])forbid(projectSelfheal,token,'local recovery must not own native Projects suppression');

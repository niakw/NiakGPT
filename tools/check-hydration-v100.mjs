...
const visualCss=read('visual-stability-v101.css');for(const token of ['body.ng8-ready::before','position:fixed','transform:translateZ(0)','content:"TOI"','content:"CHATGPT"','ng101-image-viewer-host'])need(visualCss,token);forbid(visualCss,'background-attachment:fixed','scroll-coupled fixed background reintroduced');

...
const actions=read('native-actions-v113.js');for(const token of ['invokeNativeMenu','fallbackChatMenu','fallbackMove','data-ng112-native-projects','ng113-native-actions-project','ng113-native-actions-chat'])need(actions,token,'native actions incomplete');
...
for(const token of ['ubuntu-latest, windows-latest, macos-latest','chromium, firefox, webkit','Human / DOM / errors / UX / remount / anti-churn','experience-gate-v116.mjs'])need(workflow,token,'cross-platform experience matrix incomplete');

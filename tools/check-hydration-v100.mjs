...
const isolated=[
  ...
  'reclassify-v101.js','analysis-bridge-v112.js','reclassify-deep-v112.js','locale-fr-v101.js','sidebar-authority-v107.js','sidebar-expando-guard-v108.js','sidebar-projects-authority-v112.js',
...
const folders=read('pin-folders-v096.js');need(folders,'ng96-pin-drawer');need(folders,'ng96-project-open');need(folders,'<a data-chat=');forbid(folders,'<button type="button" data-chat=','Project chat buttons reintroduced');
...
const actions=read('native-actions-v113.js');for(const token of ['invokeNativeMenu','fallbackChatMenu','fallbackMove','Déplacer vers','ng113-native-actions-project','ng113-native-actions-chat'])need(actions,token);forbid(actions,'setInterval(');

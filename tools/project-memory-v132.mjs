...
assert.equal(manifest.version, '0.9.121');
...
assert.doesNotMatch(runtime, /RATE_GUARD_KEY|HISTORY_RATE_MAX|ACCOUNT_RATE_COOLDOWN_MS|reserveHistoryRequest|cooldownUntil/,'0.9.121 must not reintroduce a NiakGPT-owned conversation rate cap');

...
for(const [engine,launcher] of Object.entries(engines)){
  ...
  try{
    ...
    await page.route('https://chatgpt.com/**',route=>route.fulfill({status:200,contentType:'text/html',body:html}));await page.goto(`https://chatgpt.com/g/g-p-test/c/${activeId}`,{waitUntil:'domcontentloaded'});await page.addScriptTag({content:code});

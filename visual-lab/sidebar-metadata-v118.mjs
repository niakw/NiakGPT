...
for(const [engine,launcher] of Object.entries(engines)){
  ...
  try{
    await page.addInitScript(()=>{
      const GOOD='g-p-good',REALDATE='g-p-date-real',BAD='dom-p-date1708',NESTED='dom-p-nested-date',CID='11111111-1111-4111-8111-111111111111',CID2='22222222-2222-4222-8222-222222222222',CID3='33333333-3333-4333-8333-333333333333';
      window.__labRaw={schema:2,at:1,projects:[{id:GOOD,name:'Studio',href:`/g/${GOOD}/project`,domOnly:false},{id:REALDATE,name:'Today',href:`/g/${REALDATE}/project`,domOnly:true},{id:BAD,name:'17/08',href:`/c/${CID}`,domOnly:true},{id:NESTED,name:'Yesterday',href:`/g/${GOOD}/c/${CID2}`,domOnly:true}],chats:[{id:CID,title:'Chat test',projectId:BAD,href:`/g/${GOOD}/c/${CID}`,updated:1},{id:CID3,title:'Real date Project chat',projectId:REALDATE,href:`/c/${CID3}`,updated:1}],counts:{[GOOD]:1,[REALDATE]:1,[BAD]:1,[NESTED]:1},projectChats:{[REALDATE]:[CID3],[BAD]:[],[NESTED]:[]},indexedProjectIds:[GOOD,REALDATE,BAD,NESTED]};
    ...
    console.log(`${engine} sidebar metadata read+write barrier + canonical badges/embedded date ghosts + shared-lock race: PASS · ${injectionMs}ms`);

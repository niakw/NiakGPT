...
for(const [engine,launcher] of Object.entries(engines)){
  ...
  try{
    ...
    await page.evaluate(()=>{document.getElementById('network-alert')?.remove();window.dispatchEvent(new Event('online'));});await page.waitForFunction(()=>window.__ng119RetryClicks===1,null,{timeout:3500});await page.waitForTimeout(450);assert(await page.evaluate(()=>window.__ng119RetryClicks)===1,'native network Retry was triggered more than once or recovery UI self-detected as a network error');

...
for(const [engine,launcher] of Object.entries(engines)){
  ...
  try{
    ...
    await page.evaluate(()=>{document.title='Wrong Browser Tab Title | ChatGPT';document.dispatchEvent(new CustomEvent('niakgpt:activity-changed',{detail:{active:false}}));});await page.waitForTimeout(260);

...
for(const [engine,launcher] of Object.entries(engines)){
  ...
  try{
    await page.addInitScript(()=>{
      ...
      window.__invalidateExtension=()=>{Object.defineProperty(window.chrome.runtime,'id',{configurable:true,value:''});window.chrome.storage.local.set=()=>{throw new Error('Extension context invalidated.');};};
    });
